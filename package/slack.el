...
(defvar slack-users (make-hash-table :shamison 'equal))
(defvar slack-channels-id (make-hash-table :zatsudan 'equal))
(defvar slack-channels-name (make-hash-table :zatsudan 'equal))
